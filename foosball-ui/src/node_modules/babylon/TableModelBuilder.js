...
class TableModelBuilder {
  ...
  static CROSSBAR_Y = TableModelBuilder.BAR_Y - (TableModelBuilder.BAR_HEIGHT / 4);
  ...
  static BASEBOARD_Y = TableModelBuilder.BAR_Y + TableModelBuilder.BAR_HEIGHT / 2;


  static GOAL_PANEL_Y = TableModelBuilder.BAR_Y + (TableModelBuilder.BAR_HEIGHT / 2);
  static GOAL_PANEL_WIDTH = TableModelBuilder.TABLE_BAR_WIDTH + TableModelBuilder.BAR_WIDTH;
  ...
  static build(scene) {
    ...
    TableModelBuilder.buildHandlePanels(scene);
  ...
  static buildBar(scene, id, mat) {
    const bar = BABYLON.MeshBuilder.CreateBox(
      id,
      { height: TableModelBuilder.BAR_HEIGHT, size: TableModelBuilder.BAR_WIDTH },
      scene
    );
    bar.material = mat;
    return bar;
  ...
  static buildGoalPanels(scene) {
    ...
    let gaolPanel1 = TableModelBuilder.buildGoalPanel(scene, 'goalPanel1', TableModelBuilder.GOAL_PANEL_WIDTH, TableModelBuilder.GOAL_PANEL_HEIGHT);
    let gaolPanel2 = TableModelBuilder.buildGoalPanel(scene, 'goalPanel2', TableModelBuilder.GOAL_PANEL_WIDTH, TableModelBuilder.GOAL_PANEL_HEIGHT);
  ...
  static buildHandlePanels(scene) {}


  static buildHandlePanel(scene, id) {}
  ...
  static buildBaseBoard(scene) {
    ...
    console.log(TableModelBuilder.BASEBOARD_Y);
