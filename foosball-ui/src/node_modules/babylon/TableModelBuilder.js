...
class TableModelBuilder {
  ...
  static buildHandles(scene) {
    ...
    const handle1Player1 = TableModelBuilder.buildPlayer(scene, "handle1-player1", playerMat);
    handle1Player1.position.y = TableModelBuilder.HANDLE_Y;
    handle1Player1.setParent(crossBar1);
    // handle1Player1.parent = crossBar1;
  }
  ...
  static buildSurface(scene) {
    ...
    const surfaceBoard = BABYLON.MeshBuilder.CreatePlane(
      "surface",
      {
